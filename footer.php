        ...
        <div class="container">
            ...
            <div class="footer-col-left">
                ...
                <?php if (!empty($button) && !empty($button['url'])) : ?>
                    <a href="<?php echo esc_url($button['url']); ?>" class="btn-outline btn-modal-sidebar-contact" target="<?php echo esc_attr($button['target']); ?>">
                        <?php echo esc_html($button['title']); ?>
                    </a>
                <?php endif; ?>

                <?php if (!empty($location_address) && !empty($location_address['url'])) : ?>
                    <a href="<?php echo esc_url($location_address['url']); ?>" class="footer-location" target="<?php echo esc_attr($location_address['target']); ?>">
                        <span class="icon-pin">
                        ...
                        <span class="underline-on-hover">
                            <?php echo esc_html($location_address['title']); ?>
                        </span>
                    </a>
                <?php endif; ?>
